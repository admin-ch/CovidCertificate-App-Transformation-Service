...
import ch.admin.bag.covidcertificate.backend.transformation.data.config.FlywayConfig;
import ch.admin.bag.covidcertificate.backend.transformation.data.config.TestConfig;
